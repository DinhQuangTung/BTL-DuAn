                                            ...
                                            <div class="show-document-item">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-8 d-flex align-items-center">
                                                        <a class="document-name" href="{{ route('documents.show', ['id' => $document->id]) }}" data-lesson-id="{{ $lesson->id }}" data-document-id="{{ $document->id }}" target="_blank">{{ $document->name }}</a>
                                                    </div>
                                                    <div class="preview col-md-2">
                                                        <a class="preview-button btn h-100" href="{{ route('documents.show', ['id' => $document->id]) }}" data-lesson-id="{{ $lesson->id }}" data-document-id="{{ $document->id }}" target="_blank">Preview</a>
                                                    </div>
                                                </div>
                                            </div>
                                        @endforeach
